...
class IosDriver extends BaseDriver {
  ...
  async startSimulator () {
    ...
    await this.setLocale(this.sim);
    await this.setPreferences(this.sim);
...
IosDriver.prototype.setLocale = setLocale;
IosDriver.prototype.setPreferences = setPreferences;
